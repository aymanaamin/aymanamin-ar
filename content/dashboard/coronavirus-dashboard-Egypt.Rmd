---
title: "لوحة مراقبة لفيرس كورونا في مصر"
author: "د. أيمن أمين"
output: 
...
df <- coronavirus %>%
  ...
  dplyr::filter(Country.Region == "Egypt") %>%
...
valueBox(
  ...
  caption = "إجمالي حالات الوفاة **(معدل الوفاة)* ",
...
### **حالات الإصابة والوفاة التراكمية اليومية** - في مصر فقط
...
plotly::plot_ly(data = df_daily) %>%
  ...
  plotly::layout(
    title = "",
    yaxis = list(title = "عدد الحالات التراكمية"),
    xaxis = list(title = "التاريخ"),
...
**The Coronavirus Dashboard: the case of Egypt**

This Coronavirus dashboard: the case of Egypt provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic for Egypt. This dashboard is built with R using the R Makrdown framework and was adapted from this [dashboard](https://ramikrispin.github.io/coronavirus_dashboard/){target="_blank"} by Rami Krispin.
